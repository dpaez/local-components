...
**Responsibilities**: Lectures and preparing practical exercises
...
Based on previous work experiences and research, spanning from fullstack development through custom JS solutions to distributed systems and P2P product development:
...
## Image References (Placeholder URLs)

Use these placeholder URLs for portfolio variations:

### Profile/Avatar

- `https://picsum.photos/seed/deka-avatar/400/400`

### Background Images

- Hero background: `https://picsum.photos/seed/patagonia-landscape/1920/1080`
- Section backgrounds: `https://picsum.photos/seed/code-abstract/800/600`

### Talk Photos

- NodeConf Colombia 2019: `https://picsum.photos/seed/deka-nodeconf-colombia-2019/800/600`
- Dat Workshop 2018: `https://picsum.photos/seed/dat-workshop-2018/800/600`
- NodeConf Argentina 2016: `https://picsum.photos/seed/nodeconf-argentina-2016/800/600`
- Node Interactive 2016: `https://picsum.photos/seed/node-interactive-2016/800/600`
